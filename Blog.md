...
**5. GRPO failed due to zero within‑group variance (all rollouts identical). With this SFT warm‑start, RL can now be re‑attempted. The environment is designed for RL; the SFT result is a baseline, not the final answer.**
